...
if __name__ == "__main__":
    ...
    parser.add_argument("--tpn-ckpt", type=str, default="results_tpn_multicross/015-GPT-B/checkpoints/0010000.pt")
    ...
    parser.add_argument("--freq_probs_path", type=str, default="/mnt/disk0/liuxh/LlamaGen/prior_counts.npy")
